...
function filterDirective ({table, pointer, operator = 'includes', type = 'string'}) {
...
function searchDirective ({table, scope = []}) {
  return Object.assign(
...
export { search, slice, summary, sort, filter, workingIndicator, table$1 as table };
